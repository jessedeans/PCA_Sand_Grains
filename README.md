...
This repository contains a MATLAB script that applies principal component analysis to sand grain sized data to determine midden locations with respect to paleo-shorelines.The write up of the study is below. The data used in this study is not mine and not available in he repository.
